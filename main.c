...
void main_function(int *Local_U32_ExitStat, int *Local_U32_BuiltinStat,
...
int main(void)
{
	size_t Local_size_BuffSize = 0, x = 0;
		...
		else if (*Local_PU8_Line != '\n')
		{
			...
			else
			{
				...
				if (Local_U32_FileStat == 0)
					...
					main_function(&Local_U32_ExitStat, &Local_U32_BuiltinStat,
